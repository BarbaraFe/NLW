...
const atualizarLista = (participantes) => {
    //Pegar informação do HTML - estrutura de repetição - loop
    let output = ""
    ...
    document.querySelector('tbody').innerHTML = output //Pesquisa pelo seletor

} //Uma variável que está contendo uma função.
